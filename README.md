...
python bot.py
```
Please note that installation instructions may differ for the **Beta branch**. Check the branch-specific instructions for Beta if you're using that branch.
...
## 📞 Contact
For support and questions, join our Discord server: [FrogBot Discord](https://discord.gg/your-discord-link)
