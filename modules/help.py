    ...
    async def advanced_help(self, inter, bot_name):
        embed = Embed(
            ...
            description=(
                ...
                "Enable, disable, or check auto-translation status for the current thread. When enabled, messages will be automatically translated based on user language preferences.\n\n"
                "**/translate set_language [language]**\n"
                "Set your preferred language for translations in the current thread.\n\n"
                "**/translate language [add/remove] [language]**\n"
                "Add or remove a language from the thread's translation list.\n\n"
                "**/translate message**\n"
